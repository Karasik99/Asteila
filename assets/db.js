...
let data = {
    ...
    "text13":{
        ...
        "lt": "Magnetinė bėgių sistema",
        "lv": "Magnētiskā sliežu sistēma"
    },
    "text14":{
    ...
    "text16":{
        "ru": "Скрытые карнизы",
        "en": "Concealed cornices",
        "lt": "Paslėpti karnizai",
        "lv": "Slēptas karnīzes"
    },
    "text17":{
    ...
    "text19":{
        "ru": "Качественный монтаж без пыли",
        "en": "Quality installation without dust",
        "lt": "Kokybiškas montavimas be dulkių",
        "lv": "Kvalitatīva uzstādīšana bez putekļiem"
    },
    "text20":{
        "ru": "Гарантия 25 лет",
        "en": "Warranty 25 years",
        "lt": "25 metų garantija",
        "lv": "25 gadu garantija"
    },
    "text21":{
        "ru": "Доверьте ваш потолок профессионалам!",
        "en": "Trust your ceiling to the professionals!",
        "lt": "Patikėkite savo lubas profesionalams!",
        "lv": "Uzticiet savus griestus profesionāļiem!"
    },
    "text22":{
        "ru": "Сделать заказ",
        "en": "To order",
    ...
    "text38":{
        "ru": "Чистый монтаж",
        "en": "Clean installation",
        "lt": "Švarus montavimas",
        "lv": "Tīra uzstādīšana"
    },
    "text39":{
    ...
    "text40":{
        ...
        "en": "Official Guarantee",
        "lt": "Oficiali garantija",
        "lv": "Oficiālā garantija"
    },
    "text41":{
        "ru": "Заключение договора, гарантия 25 лет на материалы",
        "en": "Contract conclusion, 25 years warranty on materials",
        "lt": "Sutarties sudarymas, 25 metų garantija medžiagoms",
        "lv": "Līguma noslēgšana, 25 gadu garantija materiāliem"
    },
    "text42":{
        "ru": "Безопасный монтаж",
        "en": "Safe installation",
        "lt": "Saugus montavimas",
        "lv": "Droša uzstādīšana"
    },
    "text43":{
        "ru": "Используем только безопасное и профессиональное оборудование",
        "en": "We use only safe and professional equipment",
        "lt": "Naudojame tik saugią ir profesionalią įrangą",
        "lv": "Mēs izmantojam tikai drošu un profesionālu aprīkojumu"
    },
    "text44":{
        "ru": "Ассортимент",
        "en": "Assortment",
    ...
    "text45":{
        "ru": "Большой выбор фактур и расцветок",
        "en": "Large selection of textures and colours",
        "lt": "Didelis tekstūrų ir spalvų pasirinkimas",
        "lv": "Liels tekstūru un krāsu klāsts"
    },
    "text46":{
        "ru": "Большой опыт",
    ...
    "text50":{
        ...
        "en": "Compliance with agreements and work deadlines",
        "lt": "Susitarimų ir darbo terminų laikymasis",
        "lv": "Līgumu un darba termiņu ievērošana"
    },
    "text51":{
        "ru": "Поэтапная оплата проекта",
        "en": "Phased payment for the project",
        "lt": "Mokėjimas už projektą etapais",
        "lv": "Projekta maksājumu veikšana pa posmiem"
    },
    ...
    "text56":{
        "ru": "Жалюзи & Рольшторы",
        "en": "Blinds & Curtains",
        "lt": "Žaliuzės & Užuolaidos.",
        "lv": "Žalūzijas & Aizkari."
    },
    "text57":{
    ...
    "text59":{
        "ru": "Бесплатная консультация опытного специалиста. Оперативный выезд, демонстрация примеров решений.",
        "en": "Free consultation of an experienced specialist. Prompt departure, demonstration of examples of solutions.",
        "lt": "Nemokama patyrusio specialisto konsultacija. Greitas išvykimas, sprendimų pavyzdžių demonstravimas.",
        "lv": "Pieredzējuša speciālista bezmaksas konsultācija. Ātra izbraukšana, risinājumu piemēru demonstrēšana."
    },
    ...
    "text64":{
        "ru": "Работать с нами - это просто и надежно",
        "en": "Working with us is easy and reliable",
        "lt": "Dirbti su mumis paprasta ir patikima",
        "lv": "Darbs ar mums ir vienkāršs un uzticams"
    },
    "text65":{
        "ru": "Вызов замерщика",
        "en": "Measuring call",
    ...
    "text68":{
        ...
        "en": "On-site project costing",
        "lt": "Projekto sąnaudų apskaičiavimas vietoje",
        "lv": "Projekta izmaksu aprēķins uz vietas"
    },
    "text69":{
        "ru": "Заключение договора",
        "en": "Contract conclusion",
        "lt": "Sutarties sudarymas",
        "lv": "Līguma noslēgšana"
    },
    "text70":{
        "ru": "Аванс и подписание договора на объекте",
        "en": "Advance payment and contract signing on site",
        "lt": "Išankstinis mokėjimas ir sutarties pasirašymas vietoje",
        "lv": "Avansa maksājums un līguma parakstīšana uz vietas"
    },
    "text71":{
        "ru": "Изготовление",
        "en": "Manufacturing",
    ...
    "text72":{
        ...
        "en": "Customised cutting of fabrics",
        "lt": "Individualus audinių kirpimas",
        "lv": "Audumu piegriešana pēc pasūtījuma"
    },
    "text73":{
        "ru": "Установка",
        "en": "Installation",
    ...
    "text74":{
        "ru": "В назначенный день приедет бригада и произведет качественный монтаж вашего потолка",
        "en": "A team will arrive on the appointed day and perform a quality installation of your ceiling",
        "lt": "Komanda atvyks paskirtą dieną ir kokybiškai sumontuos jūsų lubas.",
        "lv": "Komanda ieradīsies norunātajā dienā un kvalitatīvi veiks jūsu griestu uzstādīšanu."
    },
    "text75":{
        "ru": "Выполнение работ",
        "en": "Execution of works",
        "lt": "Darbų vykdymas",
        "lv": "Darbu veikšana"
    },
    "text76":{
        "ru": "Поэтапное выполнение работ с предоставлением фотоотчета",
        "en": "Step-by-step execution of works with provision of a photo report",
        "lt": "Darbų atlikimas žingsnis po žingsnio, pateikiant nuotraukų ataskaitą",
        "lv": "Darbu izpilde soli pa solim ar foto atskaiti"
    },
    "text77":{
        "ru": "Оплата",
        "en": "Payment",
    ...
    "text82":{
        "ru": "Заказывая натяжной потолок от 17м2 вы получаете в подарок установку люстры.",
        "en": "Ordering a stretch ceiling from 17m2 you get a chandelier installation as a gift.",
        "lt": "Užsisakydami įtempiamas lubas nuo 17 m2, dovanų gausite šviestuvo įrengimą.",
        "lv": "Pasūtot stieptos griestus no 17 m2, jūs dāvanā saņemat lustras uzstādīšanu."
    },
    "text83":{
        "ru": "Установка Люстры",
        "en": "Chandelier Installation",
        "lt": "Šviestuvų montavimas",
        "lv": "Lustras uzstādīšana"
    },
    "text84":{
        "ru": "Карниз",
        "en": "Cornice",
    ...
    "text85":{
        "ru": "Потолок в ванну и туалет",
        "en": "Bathroom and toilet ceiling",
        "lt": "Vonios ir tualeto lubos",
        "lv": "Vannas istabas un tualetes griesti"
    },
    "text86":{
        "ru": "10 светильников",
        "en": "10 luminaires",
    ...
    "text89":{
        "ru": "Заказывая натяжные потолки от 30м2 вы получаете в подарок установку люстры и пластиковый карниз до 3-х метров.",
        "en": "Ordering stretch ceilings from 30m2 you get as a gift the installation of chandelier and plastic cornice up to 3 metres.",
        "lt": "Užsakydami įtempiamas lubas nuo 30 m2 dovanų gausite šviestuvo ir plastikinio karnizo iki 3 metrų montavimą.",
        "lv": "Pasūtot stieptos griestus no 30 m2, jūs dāvanā saņemat lustras un plastmasas karnīzes uzstādīšanu līdz 3 metru augstumam."
    },
    "text90":{
        "ru": "от 40 м2",
        "en": "from 40 m2",
    ...
    "text91":{
        "ru": "Заказывая натяжные потолки от 40м2 вы получаете в подарок установку люстры,пластиковый карниз до 3-х метров и потолок в ванну и туалет.",
        "en": "Ordering stretch ceilings from 40m2 you get a gift installation of chandelier, plastic cornice up to 3 metres and a ceiling in the bathroom and toilet.",
        "lt": "Užsakydami įtempiamas lubas nuo 40 m2 dovanų gausite šviestuvo montavimą, plastikinį karnizą iki 3 metrų ir lubas vonios kambaryje bei tualete.",
        "lv": "Pasūtot stieptos griestus no 40 m2, jūs saņemat dāvanā lustras uzstādīšanu, plastmasas karnīzes līdz 3 metriem un griestus vannas istabā un tualetē."
    },
    "text92":{
        "ru": "от 50 м2",
        "en": "from 50 m2",
    ...
    "text93":{
        "ru": "Заказывая натяжные потолки от 50м2 вы получаете в подарок установку люстры,пластиковый карниз до 3-х метров, потолок в ванну и туалет а также 10 светильников.",
        "en": "Ordering stretch ceilings from 50m2 you get a gift installation of chandelier, plastic cornice up to 3 metres, ceiling in the bathroom and toilet, as well as 10 lamps.",
        "lt": "Užsakydami įtempiamas lubas nuo 50 m2 dovanų gausite šviestuvo, plastikinio karnizo iki 3 metrų, lubų vonios kambaryje ir tualete bei 10 šviestuvų.",
        "lv": "Pasūtot stieptos griestus no 50 m2, jūs dāvanā saņemat lustras uzstādīšanu, plastmasas karnīzes līdz 3 metriem, griestus vannas istabā un tualetē, kā arī 10 lampas."
    },
    "text112":{
        "ru": "Внимание к мелочам",
    ...
    "text114":{
        ...
        "lv": "Laipni lūgti mūsu tīmekļa vietnē"
    },
    "text115":{
    ...
    "text117":{
        ...
        "en": "Our company specialises in the design, installation and maintenance of stretch ceilings of various types and designs. We offer a wide range of materials, colours and textures to meet the needs of every customer.",
        "lt": "Mūsų įmonė specializuojasi įvairių tipų ir konstrukcijų įtempiamųjų lubų projektavimo, montavimo ir priežiūros srityje. Siūlome platų medžiagų, spalvų ir tekstūrų asortimentą, atitinkantį kiekvieno kliento poreikius.",
        "lv": "Mūsu uzņēmums specializējas dažāda veida un konstrukcijas griestu projektēšanā, uzstādīšanā un uzturēšanā. Mēs piedāvājam plašu materiālu, krāsu un faktūru klāstu, lai apmierinātu katra klienta vajadzības."
    },
    "text118":{
    ...
    "text119":{
        ...
        "en": "Our experienced specialists will help you choose the most suitable design and material for your room. We guarantee high quality service and reliable installation. In the process of work we pay attention to the smallest details to make your dreams come true.",
        "lt": "Mūsų patyrę specialistai padės išsirinkti jūsų kambariui tinkamiausią dizainą ir medžiagą. Garantuojame aukštos kokybės paslaugas ir patikimą montavimą. Dirbdami atkreipiame dėmesį į menkiausias detales, kad jūsų svajonės taptų realybe.",
        "lv": "Mūsu pieredzējušie speciālisti palīdzēs izvēlēties jūsu telpai piemērotāko dizainu un materiālu. Mēs garantējam augstas kvalitātes pakalpojumus un uzticamu uzstādīšanu. Darba procesā mēs pievēršam uzmanību vissīkākajām detaļām, lai piepildītu jūsu sapņus."
    },
    "text120":{
        "ru": "Если вы хотите преобразить интерьер своего дома, офиса или коммерческого помещения, обращайтесь к нам. Мы предлагаем доступные цены, гибкую систему скидок и индивидуальный подход к каждому клиенту.",
        "en": "If you want to transform the interior of your home, office or commercial premises, contact us. We offer affordable prices, flexible discount system and individual approach to each client.",
        "lt": "Jei norite pakeisti savo namų, biuro ar komercinių patalpų interjerą, kreipkitės į mus. Siūlome prieinamas kainas, lanksčią nuolaidų sistemą ir individualų požiūrį į kiekvieną klientą.",
        "lv": "Ja vēlaties pārveidot savas mājas, biroja vai komerctelpu interjeru, sazinieties ar mums. Mēs piedāvājam pieejamas cenas, elastīgu atlaižu sistēmu un individuālu pieeju katram klientam."
    },
    "text121":{
    ...
    "text126":{
        "ru": "Добавить отзыв",
        "en": "Add review",
        "lt": "Pridėti atsiliepimą",
        "lv": "Pievienot atsauksmi"
    },
    "text126":{
        "ru": "Добавить отзыв",
        "en": "Add review",
    ...
    "text129":{
        "ru": "Количество труб, <br> уходящих в потолок (шт.)",
        "en": "Number of pipes <br> going to the ceiling (pcs.)",
        "lt": "Vamzdžių skaičius <br> į lubas (vnt.)",
        "lv": "Cauruļu skaits <br> pie griestiem (gab.)"
    },
    ...
    "text132":{
        "ru": "Количество светильников или люстр (шт.)",
        "en": "Number of lamps or chandeliers (pcs.)",
        "lt": "Šviestuvų arba šviestuvų skaičius (vnt.)",
        "lv": "Lampu vai lustru skaits (gab.)"
    },
    "text135":{
        "ru": "Количество углов, (шт.)",
        "en": "Number of corners, (pcs.)",
        "lt": "Kampų skaičius, (vnt.)",
        "lv": "Stūru skaits, (gab.)"
    },
    "text138":{
        "ru": "Сумма может меняться в зависимости от сложности вашего проекта и местоположения",
        "en": "The amount may vary depending on the complexity of your project and location",
        "lt": "Suma gali skirtis priklausomai nuo projekto sudėtingumo ir vietos.",
        "lv": "Summa var atšķirties atkarībā no projekta sarežģītības un atrašanās vietas."
    },
    "text139":{
        "ru": "Итого:",
        "en": "Total:",
    ...
    "text159":{
        ...
        "en": "We offer our customers: quality installation of stretch ceilings and blinds. We are trusted. We are chosen.",
        "lt": "Savo klientams siūlome: kokybišką įtempiamų lubų ir žaliuzių montavimą. Mes esame patikimi. Esame pasirenkami.",
        "lv": "Mēs saviem klientiem piedāvājam: kvalitatīvu griestu un žalūziju montāžu. Mums uzticas. Mūs izvēlas."
    },

    "text164":{
        "ru": "Отправьте нам отзыв",
        "en": "Send us feedback",
        "lt": "Siųskite mums atsiliepimus",
        "lv": "Nosūtiet mums atsauksmes"
    },

    "text165":{
        "ru": "Ваше мнение всегда важно для нас",
        "en": "Your opinion is always important to us",
        "lt": "Jūsų nuomonė mums visada svarbi",
        "lv": "Jūsu viedoklis mums vienmēr ir svarīgs"
    },
